        ...
        <section className='grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4'>
            ...
            {!callDetails ? (
                ...
                >
                    ...
                    <div className="flex w-full flex-col gap-2/5 leading-[22px]
                     text-sky-2">Select Date and Time</div>
                    <ReactDatePicker
                        selected={values.dateTime}
                        onChange={(date) => setValues({ ...values, dateTime: date! })}
                        showTimeSelect timeFormat="HH:mm"
                        timeIntervals={15} timeCaption="time" dateFormat="MMMM d, yyyy h:mm aa"
